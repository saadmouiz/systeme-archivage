            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                ...
                <div class="flex flex-wrap gap-2.5">
                    <a href="{{ route('archives.beneficiaires.dashboard') }}" 
                       class="inline-flex items-center px-6 py-2 bg-[#FEE2E2] border border-red-300 text-red-900 rounded-xl hover:bg-red-200 shadow-lg hover:shadow-xl transition-all duration-200">
                    ...
                    <a href="{{ route('archives.beneficiaires.refused') }}" 
                       class="inline-flex items-center px-6 py-2 bg-red-600 border border-red-700 text-white rounded-xl hover:bg-red-700 shadow-lg hover:shadow-xl transition-all duration-200">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('archives.beneficiaires.create') }}" 
                       class="inline-flex items-center px-6 py-2 bg-[#871C1C] border border-red-300 text-white rounded-xl hover:bg-red-900 shadow-lg hover:shadow-xl transition-all duration-200">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="mb-12">
            <div class="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-white/20">
                ...
                <div class="space-y-6">
                    ...
                    <!-- Filtre par Année (pour Document éducatif) -->
                    @if(request('type') === 'Document éducatif' || request('ecole'))
                    <div>
                        <h3 class="text-sm font-semibold text-gray-700 mb-4 uppercase tracking-wider">Année</h3>
                        <div class="flex flex-wrap gap-3">
                            <a href="{{ route('archives.beneficiaires.index', array_merge(request()->except('annee'), ['type' => request('type'), 'ecole' => request('ecole')])) }}" 
