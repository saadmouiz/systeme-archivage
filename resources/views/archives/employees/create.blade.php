            ...
            <form action="{{ route('archives.employees.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="fonction" id="fonction" value="{{ old('fonction') }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        @error('fonction')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" name="date_embauche" id="date_embauche" value="{{ old('date_embauche') }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        @error('date_embauche')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" name="date_fin_contrat" id="date_fin_contrat" value="{{ old('date_fin_contrat') }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            <div class="flex items-center">
                                <input id="actif_oui" name="actif" type="radio" value="1" class="focus:ring-blue-500 h-4 w-4 text-blue-600 border-gray-300" {{ old('actif', '1') == '1' ? 'checked' : '' }}>
                                <label for="actif_oui" class="ml-3 block text-sm font-medium text-gray-700">Actif</label>
                            </div>
                            <div class="flex items-center mt-2">
                                <input id="actif_non" name="actif" type="radio" value="0" class="focus:ring-blue-500 h-4 w-4 text-blue-600 border-gray-300" {{ old('actif') == '0' ? 'checked' : '' }}>
