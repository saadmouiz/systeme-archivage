                ...
                <div class="mb-8">
                    <form action="{{ route('archives.rh.index') }}" method="GET" class="relative">
                        <div class="flex gap-4">
                            <div class="flex-1">
                                <div class="relative">
                                    ...
                                    <input type="text" 
                                           ...
                                           class="w-full pl-12 pr-4 py-4 text-lg border-2 border-gray-200 rounded-2xl shadow-sm focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-300 bg-white/50 backdrop-blur-sm"
                            ...
                            <button type="submit" 
                                    class="px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-2xl hover:from-blue-700 hover:to-blue-800 shadow-lg hover:shadow-xl transition-all duration-200 font-semibold">
                            ...
                            @foreach($visibleDocs as $doc)
                                <div class="card-hover relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-blue-200 hover:-translate-y-2 cursor-pointer" 
                                    ...
                                    <div class="flex items-start justify-between mb-6">
                                        <div class="flex-1">
                                            ...
                                            @if(isset($doc['employe_nom']) && $doc['employe_nom'])
                                                <p class="text-sm text-gray-600 mb-2 hover:text-blue-700 transition-colors duration-200">
                                    ...
                                    <div class="space-y-4 mb-6">
                                        <div class="flex items-center p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl hover:from-blue-50 hover:to-blue-100 transition-all duration-200">
                                            ...
                                            <span class="text-sm text-gray-600 font-medium hover:text-blue-700 transition-colors duration-200">
