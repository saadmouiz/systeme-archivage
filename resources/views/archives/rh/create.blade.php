...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            <div class="p-8">
                <h1 class="text-3xl font-bold text-gray-800 mb-8">Nouveau Document RH</h1>
                ...
                <form action="{{ route('archives.rh.store') }}" 
                      method="POST" 
                    ...
                    <div>
                        <label for="employe_nom" class="block text-sm font-medium text-gray-700 mb-2">Nom de l'employé</label>
                        <input type="text" 
                               name="employe_nom" 
                               id="employe_nom" 
                               class="mt-1 block w-full px-4 py-3 text-base rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-colors"
