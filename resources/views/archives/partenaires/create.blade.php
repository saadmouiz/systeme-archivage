...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            <div class="p-6">
                <h1 class="text-2xl font-bold text-gray-800 mb-6">Nouveau Partenaire</h1>
                ...
                <form action="{{ route('archives.partenaires.store') }}" 
                      method="POST" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label for="date_de_conventiont" class="block text-sm font-medium text-gray-700">Date de convention</label>
                            <input type="date" 
                    ...
                    <div>
                        ...
                        <select name="statut_partenariat" 
                            ...
                            @foreach($statuts as $key => $value)
                                <option value="{{ $key }}" {{ old('statut_partenariat') == $key ? 'selected' : '' }}>
                                    {{ $value }}
                                </option>
                            @endforeach
                        </select>
