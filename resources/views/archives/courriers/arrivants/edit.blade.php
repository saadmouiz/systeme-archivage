...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            <div class="p-8">
                <h1 class="text-3xl font-bold text-gray-800 mb-8">Modifier le Courrier Entrant</h1>
                ...
                <form action="{{ route('archives.courriers.arrivants.update', $courrier) }}" 
                      method="POST" 
                    ...
                    <div>
                        <label for="numero_arrive" class="block text-sm font-medium text-gray-700 mb-2">Numéro Arrivant *</label>
                        <input type="text" 
                               name="numero_arrive" 
                               id="numero_arrive" 
                               ...
                               value="{{ old('numero_arrive', $courrier->numero_arrive) }}" 
                               required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" 
                               ...
                               id="date_arrive" 
                               class="mt-1 block w-full px-4 py-3 text-base rounded-lg border-gray-300 shadow-sm focus:border-blue-900 focus:ring-blue-900 transition-colors"
                               value="{{ old('date_arrive', $courrier->date_arrive->format('Y-m-d')) }}" 
                               required>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" 
                                   ...
                                   id="numero_document" 
                                   class="mt-1 block w-full px-4 py-3 text-base rounded-lg border-gray-300 shadow-sm focus:border-blue-900 focus:ring-blue-900 transition-colors"
                                   value="{{ old('numero_document', $courrier->numero_document) }}">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="date" 
                                   ...
                                   id="date_document" 
                                   class="mt-1 block w-full px-4 py-3 text-base rounded-lg border-gray-300 shadow-sm focus:border-blue-900 focus:ring-blue-900 transition-colors"
                                   value="{{ old('date_document', $courrier->date_document ? $courrier->date_document->format('Y-m-d') : '') }}">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="flex items-center">
                            <input type="checkbox" 
                                   ...
                                   id="pieces_jointes" 
                                   value="1"
                                   {{ old('pieces_jointes', $courrier->pieces_jointes) ? 'checked' : '' }}
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" 
                                   ...
                                   id="renvoi" 
                                   value="1"
                                   {{ old('renvoi', $courrier->renvoi) ? 'checked' : '' }}
                                   class="h-5 w-5 text-blue-900 focus:ring-blue-900 border-gray-300 rounded">
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" 
                                   ...
                                   id="signature_recu" 
                                   value="1"
                                   {{ old('signature_recu', $courrier->signature_recu) ? 'checked' : '' }}
                                   class="h-5 w-5 text-blue-900 focus:ring-blue-900 border-gray-300 rounded">
                    ...
                    <div>
                        ...
                        <textarea name="description" 
                                  id="description" 
                                  rows="4" 
                                  class="mt-1 block w-full px-4 py-3 text-base rounded-lg border-gray-300 shadow-sm focus:border-blue-900 focus:ring-blue-900 transition-colors resize-none">{{ old('description', $courrier->description) }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        @if($courrier->fichier)
                            <div class="mb-3 p-3 bg-gray-50 rounded-lg">
                                <p class="text-sm text-gray-600">Fichier actuel : <strong>{{ basename($courrier->fichier) }}</strong></p>
                            </div>
                        @endif
                        <input type="file" 
                               name="fichier" 
