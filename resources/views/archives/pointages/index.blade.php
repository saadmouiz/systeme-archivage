            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                <div class="mb-4 lg:mb-0">
                    <div class="flex items-center mb-2">
                        <div class="w-12 h-12 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl flex items-center justify-center mr-4 shadow-lg">
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    ...
                    <a href="{{ route('archives.pointages.create') }}" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white rounded-lg font-medium transition-all duration-200 shadow-lg hover:shadow-xl">
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition-all duration-300">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-blue-600">{{ $employees->count() }}</p>
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition-all duration-300">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        @endphp
                        <p class="text-3xl font-bold text-green-600">{{ number_format($avgPresence, 1) }}%</p>
                ...
                <div class="mt-4">
                    <div class="w-full bg-gray-200 rounded-full h-2">
                        <div class="bg-green-600 h-2 rounded-full transition-all duration-500" style="width: {{ min($avgPresence, 100) }}%"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition-all duration-300">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        @endphp
                        <p class="text-3xl font-bold text-indigo-600">{{ number_format($totalHours, 0) }}</p>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-200">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <div class="w-full bg-gray-200 rounded-full h-1.5 mt-1">
                                        <div class="bg-blue-600 h-1.5 rounded-full transition-all duration-500" style="width: {{ min($pourcentagePresence, 100) }}%"></div>
                                    </div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="text-sm font-medium {{ $scorePerformance >= 80 ? 'text-green-600' : ($scorePerformance >= 60 ? 'text-yellow-600' : 'text-red-600') }}">
                                            {{ $scorePerformance }}%
                                        </div>
                                        <div class="ml-2 w-16 bg-gray-200 rounded-full h-1.5">
                                            <div class="{{ $scorePerformance >= 80 ? 'bg-green-600' : ($scorePerformance >= 60 ? 'bg-yellow-600' : 'bg-red-600') }} h-1.5 rounded-full transition-all duration-500" style="width: {{ $scorePerformance }}%"></div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex space-x-2">
                                        <a href="{{ route('archives.pointages.show', $employee) }}?mois={{ $mois }}&annee={{ $annee }}" class="inline-flex items-center px-3 py-1 border border-transparent text-xs font-medium rounded-lg text-blue-600 bg-blue-100 hover:bg-blue-200 transition-colors duration-200">
                                        ...
                                        <a href="{{ route('archives.pointages.create') }}?employee_id={{ $employee->id }}" class="inline-flex items-center px-3 py-1 border border-transparent text-xs font-medium rounded-lg text-green-600 bg-green-100 hover:bg-green-200 transition-colors duration-200">
                                            <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"/>
                                            </svg>
                                            Ajouter
