                        ...
                        <div class="flex flex-wrap gap-3">
                            ...
                            @foreach($types as $type)
                                <a href="{{ route('archives.financiers.index', ['type' => $type]) }}" 
                                   class="px-6 py-3 text-sm font-medium rounded-2xl transition-all duration-300 {{ request('type') == $type ? 'bg-[#FEE2E2] border border-red-300 text-white shadow-lg scale-105' : 'bg-white/60 text-gray-700 hover:bg-white hover:shadow-md border border-gray-200' }}">
                                    {{ $type }}
                                </a>
                            @endforeach
                        </div>
                        ...
                        <div class="flex flex-wrap gap-3">
                            @foreach($annees as $annee)
                                <a href="{{ route('archives.financiers.index', ['annee' => $annee]) }}" 
                                   class="px-6 py-3 text-sm font-medium rounded-2xl transition-all duration-300 {{ request('annee') == $annee ? 'bg-[#FEE2E2] border border-red-300 text-white shadow-lg scale-105' : 'bg-white/60 text-gray-700 hover:bg-white hover:shadow-md border border-gray-200' }}">
                                    {{ $annee }}
                                </a>
                            @endforeach
                        </div>
                    ...
                    <div class="bg-white/60 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-white/20">
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" id="docs-{{ $loop->index }}">
                            ...
                            @foreach($visibleDocs as $doc)
                                <div class="card-hover relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-red-900 hover:-translate-y-2 cursor-pointer" 
                                    ...
                                    <div class="flex items-start justify-between mb-6">
                                        <div class="flex-1">
                                            ...
                                            @if(isset($doc['reference']) && $doc['reference'])
                                                <p class="text-sm text-gray-500 font-mono bg-gray-50 px-3 py-1 rounded-lg inline-block hover:bg-red-900 hover:text-red-900 transition-all duration-200">
                                                    Réf: {{ $doc['reference'] }}
                                                </p>
                                            @endif
                                        </div>
                                        ...
                                        <div class="flex items-center space-x-2">
                                            <span class="px-3 py-1 text-xs font-semibold rounded-full 
                                                {{ $doc['statut'] === 'payé' ? 'bg-gradient-to-r from-green-100 to-green-200 text-red-900 border border-red-900' : 
                                                   ($doc['statut'] === 'en attente' ? 'bg-gradient-to-r from-yellow-100 to-yellow-200 text-red-900 border border-red-900' : 
                                                   ($doc['statut'] === 'validé' ? 'bg-gradient-to-r from-red-100 to-red-200 text-red-900 border border-red-900' :
                                    ...
                                    <div class="space-y-4 mb-6">
                                        <div class="flex items-center justify-between p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl hover:from-red-50 hover:to-red-100 transition-all duration-200">
                                            <div class="flex items-center text-gray-600 hover:text-red-900 transition-colors duration-200">
                                            ...
                                            @if(isset($doc['montant']) && $doc['montant'])
                                                <div class="text-right">
                                                    <div class="text-lg font-bold text-gray-900 hover:text-red-900 transition-colors duration-200">
