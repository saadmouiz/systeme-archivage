...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- En-tête -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900">Nouveau Visiteur</h1>
            <p class="mt-2 text-sm text-gray-600">Enregistrer un nouveau visiteur</p>
        </div>

        <!-- Formulaire -->
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
            <form action="{{ route('visiteurs.store') }}" method="POST" class="p-6">
                @csrf
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="text" name="cin" id="cin" value="{{ old('cin') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('cin') border-red-500 @enderror">
                        @error('cin')
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="datetime-local" name="heure_arrivee" id="heure_arrivee" value="{{ old('heure_arrivee', now()->format('Y-m-d\TH:i')) }}" required
